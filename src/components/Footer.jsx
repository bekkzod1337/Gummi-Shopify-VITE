...
const Footer = () => {
  return (
    <motion.footer
      ...
      className="relative w-full bg-[#FFF8F6] pt-32 pb-12 overflow-hidden"
    >
      {/* Top decorative image */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 rotate-180 w-full max-w-[1982px] h-[129px]">
        <img
          src="/hero/bg1.png"
          alt="footer top"
      ...
      <div className="container mx-auto flex flex-wrap justify-between items-start px-8 mt-24">
        ...
        >
          <img src="/logo.svg" alt="Logo" width={138} height={33} />
          <p className="text-[#454545] text-sm leading-[26px]">
        ...
        >
          <h4 className="text-[26px] font-medium">Keep In Touch</h4>
          <p className="text-[#454545] text-sm leading-[26px]">
            Subscribe to receive new product updates, be the first to know about
            sales, and more.
          </p>
          <div className="w-full max-w-[570px] border-b-2 border-black flex justify-between items-center mt-4">
        ...
        >
          <h4 className="text-[20px] font-medium">MORE INFO</h4>
          <ul className="text-[#454545] text-sm leading-[33px]">
